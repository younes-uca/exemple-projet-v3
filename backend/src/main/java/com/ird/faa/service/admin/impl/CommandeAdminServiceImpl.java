...
import com.ird.faa.service.admin.facade.CommandeTagAdminService;
...
private ArchivableService<Commande> archivableService;
        ...
        @Autowired
        private CommandeTagAdminService commandeTagService ;
        @Autowired
...
return list;
        ...
        private List<CommandeTag> prepareCommandeTags(Commande commande,List<CommandeTag> commandeTags){
        for(CommandeTag commandeTag:commandeTags ){
        commandeTag.setCommande(commande);
        }
        return commandeTags;
        }
