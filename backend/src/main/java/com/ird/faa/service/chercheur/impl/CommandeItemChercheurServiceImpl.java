...
private void prepareSave(CommandeItem commandeItem){
commandeItem.setDateCreation(new Date());
...
String query = "SELECT o FROM CommandeItem o where 1=1 ";
        ...
        query += SearchUtil.addConstraintDate( "o", "dateCreation","=",commandeItemVo.getDateCreation());
            ...
            query += SearchUtil.addConstraintMinMaxDate("o","dateCreation",commandeItemVo.getDateCreationMin(),commandeItemVo.getDateCreationMax());
