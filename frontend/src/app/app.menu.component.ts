              ...
              },
              {
                ...
                items:[
                    ...
                    },
                    {
                      label: 'Paiement tag',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/chercheur/paiement-tag/list']
                    },
                    {
                      label: 'Commande tag',
                      icon: 'pi pi-fw pi-plus-circle',
                    ...
                    {
                      label: 'Paiement detail',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/chercheur/paiement-detail/list']
                    },
                    {
                      label: 'Commande item',
                      icon: 'pi pi-fw pi-plus-circle',
              ...
              },
              {
                ...
                items:[
                    ...
                    },
                    {
                      label: 'Paiement tag',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/admin/paiement-tag/list']
                    },
                    {
                      label: 'Commande tag',
                      icon: 'pi pi-fw pi-plus-circle',
                    ...
                    },
                    {
                      label: 'Paiement detail',
                      icon: 'pi pi-fw pi-plus-circle',
                      routerLink: ['/app/admin/paiement-detail/list']
                    },
                    {
                      label: 'Commande item',
                      icon: 'pi pi-fw pi-plus-circle',
