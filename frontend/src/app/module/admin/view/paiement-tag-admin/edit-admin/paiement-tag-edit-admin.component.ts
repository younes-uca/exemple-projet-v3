...
@Component({
  selector: 'app-paiement-tag-edit-admin',
  templateUrl: './paiement-tag-edit-admin.component.html',
  styleUrls: ['./paiement-tag-edit-admin.component.css']
})
export class PaiementTagEditAdminComponent implements OnInit {
