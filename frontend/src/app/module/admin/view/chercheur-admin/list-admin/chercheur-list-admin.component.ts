...
export class ChercheurListAdminComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.initExport();
        this.initCol();
        this.yesOrNoFormationEnManagement = [{label: 'FormationEnManagement', value: null}, {label: 'Oui', value: 1}, {
            label: 'Non',
            value: 0
        }];
    ...
    prepareColumnExport(): void {
        ...
        this.criteriaData = [{
            ...
            'Equivalence avec panel erc': this.searchChercheur.equivalenceAvecPanelErc ? this.searchChercheur.equivalenceAvecPanelErc : environment.emptyForExport,
