...
export class TagListAdminComponent implements OnInit {
    ...
    constructor(private datePipe: DatePipe, private tagService: TagService, private messageService: MessageService,
                private confirmationService: ConfirmationService, private roleService: RoleService,
                private router: Router, private authService: AuthService, private exportService: ExportService, private chercheurService: ChercheurService
    ) {
    }
    ...
    get chercheurVo1(): ChercheurVo {
        return this.chercheurService.selectedChercheur;
    }

    set chercheurVo1(value: ChercheurVo) {
        this.chercheurService.selectedChercheur = value;
    }
