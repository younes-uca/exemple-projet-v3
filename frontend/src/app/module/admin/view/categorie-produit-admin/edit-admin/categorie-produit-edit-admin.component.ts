...
@Component({
  ...
  styleUrls: ['./categorie-produit-edit-admin.component.css']
})
...
public editWithShowOption(showList: boolean){
            ...
            this.selectedCategorieProduit.dateCreation = DateUtils.toDate(this.selectedCategorieProduit.dateCreation);
