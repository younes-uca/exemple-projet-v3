...
@Component({
  selector: 'app-commande-item-list-chercheur',
  templateUrl: './commande-item-list-chercheur.component.html',
  styleUrls: ['./commande-item-list-chercheur.component.css']
})
export class CommandeItemListChercheurComponent implements OnInit {
   // declarations
