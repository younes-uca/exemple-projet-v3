...
@Component({
  selector: 'app-commande-item-edit-chercheur',
  templateUrl: './commande-item-edit-chercheur.component.html',
  styleUrls: ['./commande-item-edit-chercheur.component.css']
})
export class CommandeItemEditChercheurComponent implements OnInit {
...
public editWithShowOption(showList: boolean){
            ...
            this.selectedCommandeItem.dateCreation = DateUtils.toDate(this.selectedCommandeItem.dateCreation);
