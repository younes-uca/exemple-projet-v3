...
@Component({
  selector: 'app-paiement-tag-create-chercheur',
  templateUrl: './paiement-tag-create-chercheur.component.html',
  styleUrls: ['./paiement-tag-create-chercheur.component.css']
})
export class PaiementTagCreateChercheurComponent implements OnInit {
