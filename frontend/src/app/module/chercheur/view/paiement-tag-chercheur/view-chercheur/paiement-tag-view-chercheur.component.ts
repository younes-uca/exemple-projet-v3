...
@Component({
  selector: 'app-paiement-tag-view-chercheur',
  templateUrl: './paiement-tag-view-chercheur.component.html',
  styleUrls: ['./paiement-tag-view-chercheur.component.css']
})
export class PaiementTagViewChercheurComponent implements OnInit {
