...
@Component({
  selector: 'app-paiement-tag-list-chercheur',
  templateUrl: './paiement-tag-list-chercheur.component.html',
  styleUrls: ['./paiement-tag-list-chercheur.component.css']
})
export class PaiementTagListChercheurComponent implements OnInit {
   // declarations
