...
@Component({
  selector: 'app-produit-edit-chercheur',
  templateUrl: './produit-edit-chercheur.component.html',
  styleUrls: ['./produit-edit-chercheur.component.css']
})
export class ProduitEditChercheurComponent implements OnInit {
