...
@Component({
  selector: 'app-paiement-detail-edit-chercheur',
  templateUrl: './paiement-detail-edit-chercheur.component.html',
  styleUrls: ['./paiement-detail-edit-chercheur.component.css']
})
export class PaiementDetailEditChercheurComponent implements OnInit {
