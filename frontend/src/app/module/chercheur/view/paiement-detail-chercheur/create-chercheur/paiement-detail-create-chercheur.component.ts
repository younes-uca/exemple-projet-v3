...
@Component({
  selector: 'app-paiement-detail-create-chercheur',
  templateUrl: './paiement-detail-create-chercheur.component.html',
  styleUrls: ['./paiement-detail-create-chercheur.component.css']
})
export class PaiementDetailCreateChercheurComponent implements OnInit {
