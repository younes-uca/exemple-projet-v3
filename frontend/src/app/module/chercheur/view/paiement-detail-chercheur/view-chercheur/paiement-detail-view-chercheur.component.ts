...
@Component({
  selector: 'app-paiement-detail-view-chercheur',
  templateUrl: './paiement-detail-view-chercheur.component.html',
  styleUrls: ['./paiement-detail-view-chercheur.component.css']
})
export class PaiementDetailViewChercheurComponent implements OnInit {
