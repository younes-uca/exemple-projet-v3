...
@Component({
  selector: 'app-paiement-detail-list-chercheur',
  templateUrl: './paiement-detail-list-chercheur.component.html',
  styleUrls: ['./paiement-detail-list-chercheur.component.css']
})
export class PaiementDetailListChercheurComponent implements OnInit {
   // declarations
