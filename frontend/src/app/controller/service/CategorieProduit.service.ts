...
export class CategorieProduitService {
    ...
    public save(): Observable<CategorieProduitVo> {
           return this.http.post<CategorieProduitVo>(this.API, {...this.selectedCategorieProduit,dateCreation: moment(this.selectedCategorieProduit.dateCreation).format("YYYY-MM-DD")});
    }
