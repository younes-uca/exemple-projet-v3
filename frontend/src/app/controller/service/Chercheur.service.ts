...
export class ChercheurService {
    ...
    // private _selectedChercheurv1: ChercheurVo;
    ...
    public findByUsername(tag: TagVo): Observable<ChercheurVo> {
        return this.http.get<ChercheurVo>(this.API + 'username/' + tag.username);
    }
